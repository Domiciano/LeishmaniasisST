...
public class PiernaIzquierdaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            bodyLocation = db.getListBodyLocation(paciente, format.parse(fecha_prueba), ManejadorBD.PIERNA_IZQUIERDA);
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_pierna_izquierda);
